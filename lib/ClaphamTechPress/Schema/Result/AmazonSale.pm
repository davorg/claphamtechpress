use utf8;
package ClaphamTechPress::Schema::Result::AmazonSale;
...
Related object: L<ClaphamTechPress::Schema::Result::AmazonSite>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6Q3dilGc5uk2XF8kIIqqAg
